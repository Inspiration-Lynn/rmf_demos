...
class TaskRequester(Node):
    ...
    def __init__(self, argv=sys.argv):
        ...
        # Construct task
        msg = ApiRequest()
        msg.request_id = "dropoff_" + str(uuid.uuid4())
        payload = {}
        ...
        '''
            Dropoff中的Pickup字段仅用于描述任务的起点、取货人、货物
            不参与实际的任务调度
            Pickup字段可以用于任务恢复和错误处理

            比如取消一个Dropoff任务，系统可以通知取货人来处理任务        
        '''
        ...
        # Use standard dropoff task type
